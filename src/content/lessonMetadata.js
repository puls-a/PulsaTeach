...
function projectRubricFor(id) {
  ...
  const rubrics = {
    ...
    "js-01-basics-project": ["Le total est calculé depuis les valeurs sources.", "Le message final est lisible dans la console.", "Les noms de variables décrivent leur rôle métier.", "Le code reste assez court pour être expliqué ligne par ligne."],
    "js-02-mini-project": ["La fonction expose une entrée claire et un retour explicite.", "Les deux branches de résultat sont couvertes.", "La valeur par défaut évite un cas vide fragile.", "Le module peut être testé sans interaction manuelle."],
    "js-03-arrays-project": ["La liste source reste lisible et non ambiguë.", "La transformation utilise une méthode de tableau adaptée.", "Le résultat peut être vérifié sans deviner l'état interne.", "Le code évite les mutations inutiles."],
    "js-04-dom-project": ["L'état du compteur reste identifiable.", "L'événement utilisateur déclenche une seule action claire.", "Le DOM est synchronisé après chaque clic.", "La logique peut être relue sans dépendre du HTML complet."],
    "js-05-final-project": ["Le stockage local est consulté avant l'appel réseau.", "Le fallback API est isolé dans une fonction async.", "Les données récupérées sont persistées dans un format JSON.", "La fonction retourne une donnée exploitable par l'interface."],
