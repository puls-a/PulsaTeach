export const cssModuleProfiles = {
  ...
  "css-motion": {
    scene: ["Tu ajoutes du mouvement a PulsaConf sans voler l'attention ni ignorer les préférences utilisateur.", "You add motion to PulsaConf without stealing attention or ignoring user preferences."],
...
export function cssModuleProfile(id, title) {
  return cssModuleProfiles[id] || {
    scene: [`Tu renforces ${title[0]} dans une interface PulsaTeach réelle.`, `You strengthen ${title[1]} in a real PulsaTeach interface.`],
