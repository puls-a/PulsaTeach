export const htmlTrackMetadata = {
  id: "html",
  label: "HTML",
  color: "orange",
...
export const htmlFoundationModuleIds = ["html-foundations", "html-content-navigation"];
export const htmlAdvancedModuleIds = ["html-forms-seo", "html-a11y-final"];
export const htmlWorkshopModuleIds = ["html-pulsaconf-workshop"];
export const htmlHardeningModuleIds = ["html-production-hardening"];
