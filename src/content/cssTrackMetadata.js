export const cssTrackMetadata = {
  ...
  prerequisites: { fr: ["Connaitre les bases du HTML", "Savoir lire une structure de page"], en: ["Know HTML basics", "Know how to read à page structure"] },
  outcomes: {
    ...
    en: ["Build à coherent visual system", "Master Flexbox and Grid", "Create modern responsive interfaces", "Handle interactions and motion préférences", "Audit an interface across real constraints"]
  },
  capstone: { fr: "Landing page et audit responsive complet", en: "Landing page and complète responsive audit" },
  profession: {
  ...
  certification: {
    ...
    en: ["Pass every CSS lesson and quiz", "Ship à responsive Flexbox navbar", "Justify layout, motion, and fluidity choices", "Ship the final landing without overflow", "Pass the advanced responsive audit with container queries and robust media"]
  }
};
