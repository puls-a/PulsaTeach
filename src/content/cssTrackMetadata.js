export const cssTrackMetadata = {
  ...
  summary: {
    fr: "Selecteurs, box model, Flexbox, Grid, responsive et animations avec rendu visuel.",
    en: "Selectors, box model, Flexbox, Grid, responsive, and motion with visual output."
  },
  level: { fr: "Debutant a intermediaire", en: "Beginner to intermediate" },
  ...
  outcomes: {
    fr: ["Construire un systeme visuel coherent", "Maitriser Flexbox et Grid", "Creer des interfaces responsive modernes", "Gerer les interactions et preferences de mouvement", "Auditer une interface sur plusieurs contraintes reelles"],
  ...
  certification: {
    fr: ["Valider toutes les lecons et le quiz CSS", "Livrer une navbar Flexbox responsive", "Justifier les choix de layout, mouvement et fluidite", "Livrer la landing finale sans debordement", "Reussir l'audit responsive avance avec container queries et medias robustes"],
