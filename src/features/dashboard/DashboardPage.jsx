...
import { publicLearningStats } from "../../content/publicTrackCatalog.js";
...
function ContinueCard({ lesson, kind, fr }) {
  ...
  return (
    <div className="rounded-3xl bg-white p-5 text-ink shadow-xl">
      ...
      <p className="mt-2 text-sm font-semibold text-slate-500">{lesson?.trackTitle || (fr ? `${publicLearningStats.tracks} parcours disponibles` : `${publicLearningStats.tracks} paths available`)}</p>
      {lesson && (
