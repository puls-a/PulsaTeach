...
export function FocusedLearningLayout(props) {
  ...
  return (
    <section id="learn" className={`min-h-screen overflow-x-hidden bg-[#10102b] pt-[5.75rem] text-white ${workstationLesson ? "pb-6" : "xl:h-screen xl:min-h-0 xl:overflow-hidden"}`}>
