...
export default function WorkstationWorkspace({ lesson, locale, onComplete, onNext, hasNext }) {
  ...
  return <section className="min-w-0 rounded-3xl border border-slate-200 bg-slate-50 p-3 text-ink shadow-sm sm:p-5" aria-label={fr ? "Atelier de poste de travail" : "Workstation workshop"}>
