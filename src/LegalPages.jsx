const updatedAt = "23 juin 2026";
const repositoryUrl = "https://github.com/pulsaflow/PulsaTeach";

export function PrivacyPage({ locale = "fr" }) {
  const fr = locale === "fr";
  return (
    <LegalLayout eyebrow="RGPD" title={fr ? "Politique de confidentialité" : "Privacy policy"} intro={fr ? `Dernière mise à jour : ${updatedAt}` : "Last updated: June 23, 2026"}>
...
export function CookiesPage({ locale = "fr" }) {
  const fr = locale === "fr";
  return (
    <LegalLayout eyebrow={fr ? "Cookies et stockages" : "Cookies and storage"} title={fr ? "Politique relative aux stockages locaux" : "Local storage policy"} intro={fr ? `Dernière mise à jour : ${updatedAt}` : "Last updated: June 23, 2026"}>
...
export function TermsPage({ locale = "fr" }) {
  const fr = locale === "fr";
  return (
    <LegalLayout eyebrow={fr ? "Utilisation gratuite" : "Free use"} title={fr ? "Conditions d’utilisation" : "Terms of use"} intro={fr ? `Dernière mise à jour : ${updatedAt}` : "Last updated: June 23, 2026"}>
...
export function LegalNoticePage({ locale = "fr" }) {
  const fr = locale === "fr";
  return (
    <LegalLayout eyebrow={fr ? "Informations légales" : "Legal information"} title={fr ? "Mentions légales" : "Legal notice"} intro={fr ? `Dernière mise à jour : ${updatedAt}` : "Last updated: June 23, 2026"}>
