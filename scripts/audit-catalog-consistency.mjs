...
if (lessonCount !== 865) failures.push(`expected 865 lessons, found ${lessonCount}`);
...
if (!roadmapEvidence.includes("13 parcours, 865 leçons")) failures.push("ROADMAP_EVIDENCE must state 865 lessons.");
