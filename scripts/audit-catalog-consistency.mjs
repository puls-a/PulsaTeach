...
if (lessonCount !== 878) failures.push(`expected 878 lessons, found ${lessonCount}`);
...
if (!roadmapEvidence.includes("14 parcours, 878 leçons")) failures.push("ROADMAP_EVIDENCE must state 14 parcours, 878 lessons.");
